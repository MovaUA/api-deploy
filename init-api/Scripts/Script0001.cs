...
namespace Init.Api.Scripts
{
	public class Script0001 : IScript
	{
		...
		public Script0001(
			[JetBrains.Annotations.NotNull] IMongoCollection<DbVersion> versions,
		...
		private Task CreateVersionCollection(CancellationToken cancellationToken)
		{
			...
			return this.versions.Indexes.CreateOneAsync(indexModel, cancellationToken: cancellationToken);
		}
